...
eta34_   :=   -1   :
bd11_   :=   -1   :
bd12_   :=   (r^2+u^2)/(r^2-2*M*r+a^2+Q^2)   :
bd14_   :=   (a^2-u^2)/a   :
bd21_   :=   -1/2*(r^2-2*M*r+a^2+Q^2)/(r^2+u^2)   :
bd22_   :=   -1/2   :
bd24_   :=   1/2*(r^2-2*M*r+a^2+Q^2)*(a^2-u^2)/a/(r^2+u^2)   :
...
Info_ := `Covariant NPtetrad for Kerr-Newman metric (u=a*cos(theta) to Boyer-Lindquist coordinates (J. Math. Phys. 8 265))`: 
